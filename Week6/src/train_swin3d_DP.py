...
if __name__ == "__main__":
    ...
    parser.add_argument('--model-path', type=str, default="weights/weights_swin3d_s_dp.pth",
                        help="Path from where to load the model or save (if training)")

    args = parser.parse_args()
    wandb.init(project="C6_w6_swin3d_s_dp", config=args)
    ...
    # # Freeze layers
    # num_layers_to_freeze = 100  # reduce number of layers for memory limitations
