...
from datasets.HMDB51DatasetTemporal import HMDB51DatasetTemporal
...
def create_datasets_multiview(
        ...
        temporal_stride: int,
        num_clips: int
) -> Dict[str, HMDB51DatasetTemporal]:
    """
    ...
    Returns:
        Dict[str, HMDB51DatasetTemporal]: A dictionary containing the datasets for training, validation, and testing.
    """
    datasets = {}
    datasets["validation"] = HMDB51DatasetTemporal(
        frames_dir,
        annotations_dir,
        split,
        HMDB51DatasetTemporal.Regime.VALIDATION,
        clip_length,
        crop_size,
        temporal_stride,
        num_clips=num_clips
    )
    datasets["testing"] = HMDB51DatasetTemporal(
        frames_dir,
        annotations_dir,
        split,
        HMDB51DatasetTemporal.Regime.TESTING,
        clip_length,
        crop_size,
        temporal_stride,
        num_clips=num_clips
...
if __name__ == "__main__":
    ...
    datasets = create_datasets_multiview(
        frames_dir=args.frames_dir,
        annotations_dir=args.annotations_dir,
        split=HMDB51DatasetTemporal.Split.TEST_ON_SPLIT_1, # hardcoded
        clip_length=args.clip_length,
        crop_size=args.crop_size,
        temporal_stride=args.temporal_stride,
