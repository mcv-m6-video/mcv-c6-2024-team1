...
class KalmanSpeed:
    def __init__(self, max_age=30, iou_threshold=0.4, view_transformer: ViewTransformer = None):
...
#python3 tracking_speed.py --store True --vizualize False --o_name kalman_tracking_vdo --detections bbxs_clean_tracked.json
