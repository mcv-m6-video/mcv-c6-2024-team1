...
def create_datasets(
        frames_dir: str,
        annotations_dir: str,
        split: HMDB51Dataset_RGB_difference.Split,
        clip_length: int,
        crop_size: int,
        temporal_stride: int
) -> Dict[str, HMDB51Dataset_RGB_difference]:
    """
    ...
    Args:
        ...
        split (HMDB51Dataset_RGB_difference.Split): Dataset split (TEST_ON_SPLIT_1, TEST_ON_SPLIT_2, TEST_ON_SPLIT_3).
        clip_length (int): Number of frames of the clips.
        crop_size (int): Size of spatial crops (squares).
        temporal_stride (int): Receptive field of the model will be (clip_length * temporal_stride) / FPS.

    Returns:
        Dict[str, HMDB51Dataset_RGB_difference]: A dictionary containing the datasets for training, validation, and testing.
    """
    datasets = {}
    for regime in HMDB51Dataset_RGB_difference.Regime:
        datasets[regime.name.lower()] = HMDB51Dataset_RGB_difference(
            frames_dir,
            annotations_dir,
            split,
            regime,
...
def create_dataloaders(
        datasets: Dict[str, HMDB51Dataset_RGB_difference],
        batch_size: int,
    ...
    Args:
        datasets (Dict[str, HMDB51Dataset_RGB_difference]): A dictionary containing datasets for training, validation, and testing.
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model-name', type=str, default='x3d_m_dropout',
    ...
    datasets = create_datasets(
        ...
        split=HMDB51Dataset_RGB_difference.Split.TEST_ON_SPLIT_1, # hardcoded
    ...
    y_test, y_pred = evaluate(model, loaders['testing'], loss_fn, args.device, description=f"Testing")
    
    Plots.generate_confusion_matrix(y_test, y_pred, "/ghome/group01/mcv-c6-2024-team1/Week7/plots/confusion_rgb.png")
    Plots.generate_per_class_accuracy_plot(y_test, y_pred, "/ghome/group01/mcv-c6-2024-team1/Week7/plots/per_class_acc_rgb.png")
