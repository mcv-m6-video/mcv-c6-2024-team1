...
def add_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        "--model-path",
        type=str,
        default="weights/model_rgb_dropout.pth",
...
if __name__ == "__main__":
    ...
    ops = calculate_operations(model, args.clip_length, args.crop_size, args.crop_size)
    params = calculate_parameters(model)
    print("Operations of RGB model: ",ops)
    print("Parameters of RGB model: ", params)
