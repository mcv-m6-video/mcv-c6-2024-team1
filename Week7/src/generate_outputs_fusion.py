...
def load_embeddings(test_path: str) -> Tuple[Dict, Dict]:
...
def save_outputs(
    ...
    device: str,
    description: str = "",
    save_file: str = "/ghome/group01/mcv-c6-2024-team1/Week7/results/results_fusion.pkl",
...
if __name__ == "__main__":
    ...
    test_embeddings_keypoints = load_embeddings(TEST_EMBEDDINGS_PATH)
