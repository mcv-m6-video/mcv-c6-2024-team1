...
def train(
    ...
    loss_train_mean = rolling_mean.RollingMean(window_size=len(train_loader))
...
if __name__ == "__main__":
    ...
    per_class_accuracy = rolling_mean.evaluate_per_class_accuracy(model, loaders['validation'], args.device)

    Plots.generate_per_class_accuracy_plot(per_class_accuracy, "RGB_difference_per_class")
